...
(function () {
  ...
  function renderWeather() {
    ...
    root.innerHTML = weatherHours.map(function (h) {
      return '<article class="wh-cell"><time>' + h.t + '</time><div class="ico">' + h.ico +
        '</div><span class="lab">' + h.lab + '</span><strong>' + h.temp + '°C</strong></article>';
    }).join("");
  }
  ...
  function renderWind() {
    ...
    root.innerHTML = windHours.map(function (h) {
      return '<article class="w-cell"><time>' + h.t + '</time><div class="tri ' + h.cls +
        '" style="--deg:' + h.deg + 'deg"></div><div class="dir">' + h.dir +
        '</div><strong>' + h.bf + '</strong><small>' + h.km + ' km/h</small></article>';
    }).join("");
  }
  ...
  function renderCurrents() {
    ...
    root.innerHTML = currentHours.map(function (h) {
      return '<article class="c-cell"><time>' + h.t + '</time><div class="tri ' + h.cls +
        '" style="--deg:' + h.deg + 'deg"></div><div class="dir">' + h.dir +
        '</div><strong>' + h.kn + ' kn</strong></article>';
    }).join("");
  }
