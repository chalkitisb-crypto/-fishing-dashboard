/* Fishing Dashboard v13.0 — Kalymnos ready */
(function () {
  "use strict";

  var weatherHours = [
    { t: "08:00", ico: "☀️", icon: "icon_sun.png", lab: "Ηλιοφάνεια", temp: 22 },
    { t: "09:00", ico: "🌤️", icon: "icon_partly.png", lab: "Αραιή συννεφιά", temp: 23 },
    { t: "10:00", ico: "🌤️", icon: "icon_partly.png", lab: "Αραιή συννεφιά", temp: 24 },
    { t: "11:00", ico: "⛅", icon: "icon_partly.png", lab: "Αραιή συννεφιά", temp: 25 },
    { t: "12:00", ico: "☁️", icon: "icon_cloud.png", lab: "Συννεφιά", temp: 25 },
    { t: "13:00", ico: "☁️", icon: "icon_cloud.png", lab: "Συννεφιά", temp: 26 },
    { t: "14:00", ico: "🌤️", icon: "icon_partly.png", lab: "Αραιή συννεφιά", temp: 26 }
  ];
  ...
  var pressurePts = [1017, 1019, 1016, 1021, 1018, 1022, 1019];
  var tidePts = [0.2, 0.55, 0.15, 0.7, 0.25, 0.6, 0.35];
  ...
  function renderWeather() {
    ...
    root.innerHTML = weatherHours.map(function (h) {
      var ic = h.icon || '';
      var icHtml = ic ? '<img class="wico" src="'+ic+'" alt=""/>' : '<div class="ico">'+h.ico+'</div>';
      return '<article class="wh-cell"><time>' + h.t + '</time>' + icHtml +
        '<span class="lab">' + h.lab + '</span><strong>' + h.temp + '°C</strong></article>';
    }).join("");
  }
  ...
  function drawPressure() {
    ...
    var xs = pressurePts.map(function (_, i) {
      return pad + (i * (w - pad * 2)) / (pressurePts.length - 1);
    });
    ...
    var d = "M" + xs[0] + "," + h + " " + xs.map(function (x, i) {
      return "L" + x + "," + ys[i];
  ...
  function drawTide() {
    ...
    var xs = tidePts.map(function (_, i) {
      return pad + (i * (w - pad * 2)) / (tidePts.length - 1);
    });
